...
export default function Home() {
  ...
  return (
    <main className="relative flex flex-col items-center min-h-screen overflow-hidden">
      ...
      <section
        id="hero-section"
        className="relative z-10 flex flex-col items-center w-full max-w-5xl mx-auto px-6 pt-8 pb-4 sm:pt-12 sm:pb-6"
      >
        {/* Badge */}
      ...
      <section
        id="features-section"
        className="relative z-10 w-full max-w-5xl mx-auto px-6 pt-10 pb-20 sm:pt-12 sm:pb-28"
      >
